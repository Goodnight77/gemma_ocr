                    ...
                    response = ollama.chat(
                        ...
                        messages=[{
                            ...
                            'content': """Analyze the text in the provided image. Extract all readable content
                                        and present it in a structured Markdown format that is clear, and well-organized. Ensure proper formatting 
                                        (e.g., headings, lists, or
...
# Footer
st.markdown("---")
st.markdown("Made with ❤️ using Gemma-3 Vision Model by [Ollama](https://ollama.com)")